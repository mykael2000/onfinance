...
<head>
    ...
    body {
        ...
        /* Very light, inviting background */
    }
...
<body class="bg-gray-50 font-sans text-gray-900">
    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-lg">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex space-x-8 text-base font-semibold">
                <a href="https://moneylitafrica.com" class="hover:text-amber-500 transition duration-300">
                    MoneyLit
                </a>
                ...
                <a href="#contact"
                    class="px-5 py-2 rounded-full bg-primary text-white font-bold hover:bg-emerald-900 transition duration-300 custom-shadow">Collaborate</a>
            </div>
            <!-- Mobile Menu Button (Hamburger) -->
            <button class="md:hidden p-2 text-gray-700 rounded-lg hover:bg-gray-100 focus:outline-none"
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-xl py-4 absolute w-full">
            <a href="#about"
                class="block px-6 py-2 text-base text-gray-700 hover:bg-emerald-50 border-b border-gray-100">About
                Omoefe</a>
            <a href="#events"
                class="block px-6 py-2 text-base text-gray-700 hover:bg-emerald-50 border-b border-gray-100">Events &
                Impact</a>
            <a href="#vision"
                class="block px-6 py-2 text-base text-gray-700 hover:bg-emerald-50 border-b border-gray-100">Vision</a>
            <a href="#gallery"
                class="block px-6 py-2 text-base text-gray-700 hover:bg-emerald-50 border-b border-gray-100">Highlights</a>
            <a href="#contact"
                class="block px-6 py-3 text-base text-white bg-primary mx-4 my-3 rounded-xl text-center font-bold">Collaborate
                Now</a>
        </div>
    </header>
    ...
    <section
        class="bg-gradient-to-tr from-emerald-800 via-emerald-700 to-emerald-900 px-6 md:px-12 py-20 text-center text-white rounded-b-3xl shadow-lg">
        <h1 class="text-4xl md:text-6xl font-extrabold mb-4 font-serif">Introducing ON Finance — Our Impact Movement
        </h1>
        <p class="md:max-w-3xl mx-auto text-lg md:text-xl font-medium leading-relaxed mb-8">
            Money Lit Africa is evolving. Through ON Finance, we’re building an Africa where financial knowledge creates
            real change.<br>
            Our goal? To empower 100,000+ Africans with the tools, access, and community to achieve lasting financial
            freedom.
        </p>
        <div class="space-x-6">
            <a href="#learn"
                class="inline-block bg-amber-400 hover:bg-amber-500 text-emerald-900 font-bold px-8 py-3 rounded-xl shadow-md transition">Learn
                More About ON Finance</a>
            <a href="#partner"
                class="inline-block bg-transparent border-2 border-amber-400 hover:bg-amber-400 hover:text-emerald-900 text-white font-bold px-8 py-3 rounded-xl transition">Partner
                With Us</a>
        </div>
    </section>
    ...
    <section class="flex flex-col md:flex-row items-center md:justify-between px-6 md:px-12 py-20 max-w-7xl mx-auto">
        <div class="md:w-1/2 mb-12 md:mb-0">
            <h2 class="text-5xl font-extrabold color-primary mb-4 font-serif">Empowering Africa Through Financial
                Education and Access</h2>
            <p class="text-lg text-gray-700 mb-8 leading-relaxed max-w-lg">
                ON Finance is a movement turning financial literacy into measurable empowerment for women, youth, and
                underserved communities across the continent.
            </p>
            <div class="space-x-6">
                <a href="#join"
                    class="inline-block bg-amber-400 hover:bg-amber-500 text-emerald-900 font-bold px-8 py-3 rounded-xl shadow-md transition">Join
                    the Movement</a>
                <a href="#partner"
                    class="inline-block border-2 border-amber-400 hover:bg-amber-400 hover:text-emerald-900 text-amber-400 font-bold px-8 py-3 rounded-xl transition">Become
                    a Partner</a>
            </div>
        </div>
        <div class="md:w-1/2">
            <img src="img/Moneylit5.jpg" alt="Empowering Africa through finance"
                class="rounded-3xl shadow-lg max-w-full object-cover" />
        </div>
    </section>
    ...
    <section class="bg-white py-20 px-6 md:px-12 max-w-7xl mx-auto rounded-3xl shadow-md">
        <h3 class="text-4xl font-extrabold color-primary mb-6 font-serif border-b-4 border-amber-400 inline-block pb-2">
            Our Purpose Is Simple — Empowerment Through Financial Literacy</h3>
        <p class="text-lg text-gray-700 max-w-4xl leading-relaxed">
            ON Finance exists to close Africa’s financial knowledge gap.<br>
            We believe that financial education is not just about money, it’s about dignity, opportunity, and
            freedom.<br>
...
<br><br>
    ...
    <section class="py-20 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <ul class="list-disc pl-6 space-y-3 text-gray-800 max-w-xl font-medium">
            ...
            <li><strong>Finance Ambassador Network</strong> – Training volunteers to bring financial literacy into their
        ...
        <div class="grid gap-12 lg:grid-cols-2">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-xl border-t-4 border-pink-500 custom-shadow">
                ...
                <div class="space-y-4 text-gray-600 text-base">
                    <p>In celebration of International Women’s Day, we brought together women professionals and
                        entrepreneurs for honest conversations about wealth creation and financial independence.</p>
                    ...
                    <ul class="list-none space-y-2 text-sm ml-0">
                        <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-amber-500" fill="currentColor"
                            ...
                            </svg>Panel discussions on investing</li>
                        <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-amber-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z">
                                </path>
                            </svg>Networking and mentorship</li>
                        <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-amber-500" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z">
                                </path>
                            </svg>50+ participants empowered</li>
                    </ul>
                    <a href="#gallery"
                        class="mt-4 block w-full text-center px-4 py-3 bg-pink-500 text-white font-semibold rounded-xl hover:bg-pink-600 transition duration-300">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-xl border-t-4 border-secondary custom-shadow">
                ...
                <div class="space-y-4 text-gray-600 text-base">
                    <p>We regularly host informal or community sessions both online and offline, emphasizing my role as
                        a thought leader driving critical conversations around wealth, investing, and economic
                        empowerment across Africa.</p>
                    <p class="pt-2">Join us to get involved in the discussion and start making measurable progress on
                        your financial goals.</p>
                    <a href="#contact"
                        class="mt-6 block w-full text-center px-4 py-3 bg-secondary color-primary font-bold rounded-xl hover:bg-amber-400 transition duration-300">
    ...
    <section class="bg-white py-20 px-6 md:px-12 max-w-7xl mx-auto rounded-3xl shadow-md">
        <h3 class="text-4xl font-extrabold color-primary mb-6 font-serif border-b-4 border-amber-400 inline-block pb-2">
            Turning Learning Into Measurable Change</h3>
        <p class="text-lg text-gray-700 max-w-4xl leading-relaxed mb-8">
        ...
        <a href="#impact-report"
            class="inline-block mt-8 bg-amber-400 hover:bg-amber-500 text-emerald-900 font-bold px-8 py-3 rounded-xl shadow-md transition">Read
            Our Impact Report &rarr;</a>
    </section>
    ...
    <section id="partner" class="py-20 px-6 md:px-12 max-w-7xl mx-auto">
        <h3 class="text-4xl font-extrabold color-primary mb-6 font-serif border-b-4 border-amber-400 inline-block pb-2">
            Partner With Purpose</h3>
        <p class="text-lg text-gray-700 max-w-4xl leading-relaxed mb-8">
            We collaborate with fintechs, NGOs, development organizations, and purpose-driven brands to create programs
            that drive financial inclusion.
            Whether it’s sponsoring a workshop, funding a campaign, or co-hosting an event — your partnership can help
            shape a financially confident Africa.
        </p>
        <div class="space-x-6">
            <a href="#become-partner"
                class="inline-block bg-amber-400 hover:bg-amber-500 text-emerald-900 font-bold px-8 py-3 rounded-xl shadow-md transition">Become
                a Partner</a>
            <a href="ON_Finance_Partnership_Deck.pdf"
                class="inline-block border-2 border-amber-400 hover:bg-amber-400 hover:text-emerald-900 text-amber-400 font-bold px-8 py-3 rounded-xl transition"
                download>Download Partnership Deck</a>
        </div>
    </section>
    ...
    <section class="py-20 px-6 md:px-12 max-w-7xl mx-auto text-center bg-white rounded-3xl shadow-lg text-emerald-400">
        <h3 class="text-4xl font-extrabold mb-6 font-serif border-b-4 border-amber-400 inline-block pb-2">Guided by
            Visionaries</h3>
        <div class="grid grid-cols-1 sm:grid-cols-1 gap-8 max-w-6xl mx-auto">
            ...
            <div class="text-center p-6 shadow-lg rounded-xl">
                <img src="img/money3.jpg" alt="Finance Expert"
                    class="mx-auto rounded-full w-32 h-32 object-cover mb-4 shadow-md" />
    ...
    <section class="py-20 px-6 md:px-12 max-w-7xl mx-auto text-center bg-emerald-900 rounded-3xl shadow-lg text-white">
        <h3 class="text-4xl font-extrabold mb-6 font-serif border-b-4 border-amber-400 inline-block pb-2">Join the
            Movement</h3>
        ...
        <div class="space-x-6">
            <a href="#join-us"
                ...
                Us</a>
            <a href="#support"
                class="inline-block border-2 border-amber-400 hover:bg-amber-400 hover:text-emerald-900 text-white font-bold px-8 py-3 rounded-xl transition">Support
                Our Work</a>
        </div>
    </section>
    ...
    <footer class="bg-amber-400 text-emerald-900 py-10 mt-16 text-center font-medium rounded-t-3xl px-6">
        ON Finance is dedicated to empowering Africans through financial education, access, and community-driven
        programs.
    </footer>
</body>
